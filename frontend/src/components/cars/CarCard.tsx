...
export const CarCard: React.FC<CarCardProps> = ({ car, onClick }) => {
  ...
  return (
    <div
      className="group bg-white rounded-xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col h-full relative"
    >
      ...
      >
        ...
        <div className="absolute top-3 right-3 flex gap-2">
          ...
          <div className="bg-white/90 backdrop-blur px-2 py-1 rounded text-xs font-bold text-slate-900 flex items-center">
            {car.year}
          </div>
        </div>
      </div>
