      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              {[Facebook, Instagram, Twitter].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-kimchi-red hover:text-white transition-all duration-300">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={item.label}>
                  <button onClick={() => onNavigate(item.path)} className="text-gray-400 hover:text-kimchi-red transition-colors flex items-center gap-2 group">
          ...
          <div>
            ...
            <ul className="space-y-6">
              <li className="flex gap-4">
                <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center shrink-0 text-kimchi-red">
                  <MapPin className="w-5 h-5" />
                </div>
                <div>
                  <p className="font-bold text-white">Main Showroom</p>
                  <p className="text-gray-400 text-sm">123 Gangnam-daero, Seoul, South Korea</p>
              ...
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">concierge@kimchimotors.com</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6">Subscribe to receive updates on new arrivals and exclusive offers.</p>
            <div className="relative">
              <input
                type="email"
                placeholder="Your email address"
                className="w-full bg-white/5 border border-white/10 rounded-full py-3 px-6 text-white placeholder-gray-500 focus:outline-none focus:border-kimchi-red transition-colors"
              />
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">© 2024 Kimchi Motors. All rights reserved.</p>
